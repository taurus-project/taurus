...
{
    resize(850, 550);
    setWindowTitle(tr("Taurus") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Taurus address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Taurus"), this);
    aboutAction->setStatusTip(tr("Show information about Taurus"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Taurus"));
    ...
    secondAuthAction->setStatusTip(tr("Second auth with your Taurus addresses"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Taurus client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Taurus client"));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Taurus address or malformed URI parameters."));
    }
