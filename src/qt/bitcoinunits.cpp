...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Tauruss"));
    case mBTC: return QString(QObject::tr("Milli-Tauruss (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Tauruss (1 / 1,000,000)"));
    default: return QString("???");
    }
}
