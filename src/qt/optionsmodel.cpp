...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("strThirdPartyTxUrls")) {
        if(fTestNet)
            ...
            settings.setValue("strThirdPartyTxUrls", "https://bitinfocharts.com/taurus/tx/%s|https://coinplorer.com/TAU/Transactions/%s|https://explorer.novaco.in/tx/%s|https://bchain.info/TAU/tx/%s");
    }
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "https://bitinfocharts.com/taurus/tx/%s|https://coinplorer.com/TAU/Transactions/%s|https://explorer.novaco.in/tx/%s|https://bchain.info/TAU/tx/%s").toString();
